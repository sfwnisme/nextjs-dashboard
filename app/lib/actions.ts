...
export async function createInvoice(prevState: State, formData: FormData) {
  ...
  try {
    ...
    // you can use Object.entries() if you have many inputs
    // const rawFormData2 = Object.fromEntries(formData.entries());
    // console.log("entries----", rawFormData2);
  } catch (error) {
...
export async function updateInvoice(
  ...
  try {
    ...
    return {
      message: "Database Error: Faild to Update",
    };
  }
  revalidatePath("/dashboard/invoices");
  redirect("/dashboard/invoices");
...
export async function deleteInvoice(id: string) {
  ...
  try {
    ...
    return {
      message: "Database Error: Faild to Delete",
    };
  }
  revalidatePath("/dashboard/invoices");
}
